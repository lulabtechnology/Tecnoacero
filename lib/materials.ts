...
export const materials: Material[] = [
  {
    ...
    badge: "Bajo carbono",
    image: "/images/client-products/acero-aisi-1018-1020-final.webp",
    ...
    presentations: ["Barras redondas", "Barras cuadradas", "Barras hexagonales", "Platinas calibradas", "Cortes a medida"],
            gallery: [
      { src: "/images/client-products/acero-aisi-1018-1020-final.webp", alt: "Barra AISI 1018 / 1020", label: "Barra AISI 1018 / 1020" },
  ...
  },
  {
    ...
    badge: "Alta abrasión",
    image: "/images/client-products/lamina-antidesgaste-450-500-final.webp",
    ...
    presentations: ["Láminas", "Cortes a medida", "Piezas preparadas para proyecto"],
        gallery: [
      { src: "/images/client-products/lamina-antidesgaste-450-500-final.webp", alt: "Lámina antidesgaste 450 / 500", label: "Lámina antidesgaste 450 / 500" },
    ],
    specs: [
  ...
  },
  {
    ...
    gallery: [
      { src: "/images/client-products/aluminio-barra-redonda.webp", alt: "Barra redonda de aluminio", label: "Barra redonda de aluminio" },
      { src: "/images/client-products/aluminio-barra-cuadrada.webp", alt: "Barra cuadrada de aluminio", label: "Barra cuadrada de aluminio" },
      { src: "/images/client-products/aluminio-angular.webp", alt: "Angular de aluminio", label: "Angular de aluminio" },
      { src: "/images/client-products/aluminio-platina.webp", alt: "Platina de aluminio", label: "Platina de aluminio" },
      { src: "/images/client-products/aluminio-lamina-lisa.webp", alt: "Lámina lisa de aluminio", label: "Lámina lisa de aluminio" },
      { src: "/images/client-products/aluminio-lamina-estriada.webp", alt: "Lámina estriada de aluminio", label: "Lámina estriada de aluminio" },
    ],
    specs: [
  ...
  },
  {
    ...
    badge: "Poliamida",
    image: "/images/client-products/nylon-blanco-final.webp",
    ...
    presentations: ["Barras", "Láminas", "Cortes a medida"],
            gallery: [
      { src: "/images/client-products/nylon-blanco-final.webp", alt: "Nylon blanco en barras y placas", label: "Nylon blanco" },
      { src: "/images/client-products/nylon-barra-negra.webp", alt: "Nylon negro en barras", label: "Nylon negro" },
  ...
  },
  {
    ...
    category: "Plásticos de ingeniería",
    badge: "Baja fricción",
    image: "/images/client-products/teflon-laminas-barras-final.webp",
    ...
    presentations: ["Barras redondas", "Cortes a medida", "Piezas para maquinado"],
            gallery: [
      { src: "/images/client-products/teflon-laminas-barras-final.webp", alt: "Teflón láminas y barras", label: "Teflón láminas y barras" },
    ],
    specs: [
  ...
  },
  {
    ...
    badge: "Perfiles",
    image: "/images/client-products/acero-estructural-a36-final.webp",
    ...
    presentations: ["Láminas", "Barras", "Angulares", "Tubos", "Platinas", "Vigas", "Cortes a medida"],
            gallery: [
      { src: "/images/client-products/acero-estructural-a36-final.webp", alt: "Hierro A36 o estructural", label: "Hierro A36 o estructural" },
    ],
    specs: [
